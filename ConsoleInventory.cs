// Project:  ConsoleInventory
// Description: Simple inventory system that uses an array of structs (no database) to store information.
// Using arrays will limit us to create a new array when deleting items.
                ...
                switch (choice)
                {
                    ...
                    case "3":
                        ...
                        else
                        {
                            ...
                            //// For testing purposes only (to see both arrays, uncomment this section)
                            //refNumber = 0;
